...
/*
Package logoutpb is a reverse proxy.
...
func request_LogoutService_LogoutUserService_0(ctx context.Context, marshaler runtime.Marshaler, client LogoutServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := client.LogoutUserService(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
...
func RegisterLogoutServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client LogoutServiceClient) error {
	...
	mux.Handle("POST", pattern_LogoutService_LogoutUserService_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_LogoutService_LogoutUserService_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_LogoutService_LogoutUserService_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_LogoutService_LogoutUserService_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "user", "logout"}, ""))
)

var (
	forward_LogoutService_LogoutUserService_0 = runtime.ForwardResponseMessage
)
