...
/*
Package loginpb is a reverse proxy.
...
func request_LoginService_LoginUserService_0(ctx context.Context, marshaler runtime.Marshaler, client LoginServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := client.LoginUserService(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
...
func RegisterLoginServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client LoginServiceClient) error {
	...
	mux.Handle("POST", pattern_LoginService_LoginUserService_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_LoginService_LoginUserService_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_LoginService_LoginUserService_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_LoginService_LoginUserService_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "user", "login"}, ""))
)

var (
	forward_LoginService_LoginUserService_0 = runtime.ForwardResponseMessage
)
