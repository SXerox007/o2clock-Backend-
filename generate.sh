...
# OR
curl -i -H "Content-Type: application/json" -X GET 'https://e7813162.ngrok.io/v1/user/password/forgot?email=sumit@bonfleet.com'

# Curl reset password
curl -i -H "Content-Type: application/json" -X GET 'https://e7813162.ngrok.io/v1/user/setpassword/xyx'
